...
\textbf{AI Model} & Model runs locally; retry path for capture/transcription failures; transcript shown before transmission; raw audio discarded after transcription; low end-to-end latency \\
\rowcolor{yellow!20}
